...
import os, parse, difflib, copy, sys
import p1, p3
...
if __name__ == "__main__":
    ...
    if problem_id == -1 or problem_id == 1: grade(1, -6, p1.random_play_single_ghost, parse.read_layout_problem)
    if problem_id == -1 or problem_id == 2: print('Grading Problem 2 : To be done manually by TA')
    if problem_id == -1 or problem_id == 3: grade(3, -7, p3.random_play_multiple_ghosts, parse.read_layout_problem)
    if problem_id == -1 or problem_id == 4: print('Grading Problem 4 : To be done manually by TA')
    if problem_id == -1 or problem_id == 5: print('Grading Problem 5 : To be done manually by TA')
    if problem_id == -1 or problem_id == 6: print('Grading Problem 6 : To be done manually by TA')